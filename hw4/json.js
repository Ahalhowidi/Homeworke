var movieList = {"Search":[
	...
	"imdbID":"tt0200027",
	"Type":"movie",
	"Poster":"https://images-na.ssl-images-amazon.com/images/M/MV5BOGM5MzU5NTgtMmJjZC00Y2E2LThhZGQtMGE5YzUxZTgwZDdlXkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_SX300.jpg"},
	{"Title":"Used Cars",
	"Year":"1980",
	"imdbID":"tt0081698",
	"Type":"movie",
	"Poster":"https://images-na.ssl-images-amazon.com/images/M/MV5BMTkyNTQxOTk2Ml5BMl5BanBnXkFtZTcwODc5MjIyMQ@@._V1_SX300.jpg"},
	{"Title":"Old Men in New Cars",
	"Year":"2002",
	"imdbID":"tt0246692",
	"Type":"movie",
	...
	"imdbID":"tt2314952",
	"Type":"series",
	"Poster":"https://images-na.ssl-images-amazon.com/images/M/MV5BMTc2OTQ3OTkwMF5BMl5BanBnXkFtZTgwNjAwMzkxOTE@._V1_SX300.jpg"},
	{"Title":"The Cars That Eat People",
	"Year":"1974",
	"imdbID":"tt0071282",
	"Type":"movie",
	"Poster":"https://images-na.ssl-images-amazon.com/images/M/MV5BMTI5NDAzMjM0NV5BMl5BanBnXkFtZTcwNDE4MzE2MQ@@._V1_SX300.jpg"},
	{"Title":"Counting Cars",
	"Year":"2012–",
	"imdbID":"tt2338096",
	"Type":"series",
	"Poster":"https://images-na.ssl-images-amazon.com/images/M/MV5BMTA4MzkyODYxNTdeQTJeQWpwZ15BbWU4MDM1MjYwMTMx._V1_SX300.jpg"},
	...
	"Poster":"https://images-na.ssl-images-amazon.com/images/M/MV5BMTc4NDQ3OTg4M15BMl5BanBnXkFtZTYwMTc3MDM1._V1_SX300.jpg"
		}],"totalResults":"221","Response":"True"};
...
function createInfoElement(info) {
    ...
    var textTitle = document.createTextNode(info.Title);
    poster.setAttribute("src", info.Poster);
    poster.setAttribute("id", "poster");
    listMovie.setAttribute("class", "contant");
    listInfo.setAttribute("class", "movieInfo");
    listTitle.setAttribute("class", "titles");
    link.setAttribute("href", 'http://www.imdb.com/title/'+info.imdbID);
    link.setAttribute("target", '_blanck');
    link.setAttribute("id", 'imdbLink');
    ...
    listMovie.appendChild(listTitle);
    listMovie.appendChild(listInfo);                            
    return listMovie;
};
